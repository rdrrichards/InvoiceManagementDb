...
**	Procedure Name: usp_invoice_item_get_by_order_item
**	Author: Richard Richards
**	Created: 06/23/2015
**	Copyright: QIQO Software, (c) 2015
******************************************************************/

CREATE PROC [dbo].[usp_invoice_item_get_by_order_item]
	@order_item_key int
AS
SET NOCOUNT ON
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[usp_invoice_item_get_by_order_item] TO [businessuser]
    AS [dbo];
